...
void function register() {
  ...
  if (typeof webpackExports === 'function') {
    reactHotLoader.register(webpackExports, 'module.exports', "C:\\outlook-add-in\\src\\commands\\commands.ts");
    return;
  ...
  for (var key in webpackExports) {
    ...
    reactHotLoader.register(namedExport, key, "C:\\outlook-add-in\\src\\commands\\commands.ts");
  }
}();
